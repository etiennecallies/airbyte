...
import pytest
from source_modjo.source import ModjoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ModjoStream, "path", "v0/example_endpoint")
    mocker.patch.object(ModjoStream, "primary_key", "test_primary_key")
    mocker.patch.object(ModjoStream, "__abstractmethods__", set())
